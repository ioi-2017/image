...
# ----- Installation of software in Ubuntu repositories -----
...
## IDEs and Editors
apt-get -y install codeblocks codeblocks-contrib emacs geany geany-plugins gedit vim-gnome joe kate kdevelop lazarus nano vim
...
## Documentation
apt-get -y install stl-manual openjdk-8-doc openjdk-8-source fp-docs python2.7-doc python3-doc
